...
def load_model(param, device):
    ...
    # Load from pre-trained
        ...
        model_weights = os.path.join(model_folder, f'{param.model_name}_{param.pretrained_dataset}.pth')
        ...
        # Load configuration
        config_file = get_config_path(root_dir, param.model_name, param.pretrained_dataset)
